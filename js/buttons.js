...
function setAudioSource(ID) {
  ...
  switch (ID) {
      ...
      case '4':audioElement.setAttribute('src', dashmeshCultureCenterCalgary);break;  
      case '5':audioElement.setAttribute('src', dukhNivaranSahibSurrey);break;  
      case '6':audioElement.setAttribute('src', fremontGurdwaraCalifornia);break;  
      case '7':audioElement.setAttribute('src', guruNanakSikhGurdwaraSurrey);break;  
      case '8':audioElement.setAttribute('src', dasmeshDarbarSurrey);break;  
